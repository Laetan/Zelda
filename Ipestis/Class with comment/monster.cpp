...
//Drop function. Create object or nothing depending on the drop rate defined.
void Monster::drop()
{
    //Random number for the drop
...
//Remove and delete monster's item from the scene, and trigger the drop function
void Monster::death(){
    drop();
